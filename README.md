...
## 概要
教員と管理者向けの学校管理システムです。クラス管理、学生管理、授業回管理、小テスト管理、ピア評価などの機能を提供します。
...
### 管理者機能
- **管理者ダッシュボード**: システム全体の統計情報
- **教員管理**: 教員アカウントの作成・管理
- **全ユーザー管理**: 管理者・教員・学生の一覧表示
...
#### 管理者アカウント
- **メールアドレス**: admin@school.com
- **パスワード**: admin123
- **権限**: システム管理者（教員管理、全ユーザー管理）
- **注意**: このパスワードは初回ログイン後に必ず変更してください
...
### 主要モデル
- **CustomUser**: 統合ユーザーモデル（管理者・教員・学生）
- **ClassRoom**: クラス
- **LessonSession**: 授業回
- **Group**: グループ
- **Quiz**: 小テスト
...
#### 管理者の場合
1. **ログイン**: 管理者アカウント（admin@school.com）でログイン
2. **管理者ダッシュボード**: システム統計の確認
3. **教員管理**: 新しい教員アカウントを作成
4. **ユーザー管理**: 全ユーザーの状況を監視
